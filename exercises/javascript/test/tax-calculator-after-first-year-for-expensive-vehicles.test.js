...
describe('Tax calculator on expensive vehicles over 50K after the first year', () => {
  let taxCalculator = new DummyTaxCalculator();
  let FIRST_OF_APRIL_2017 = new Date(2017, 4, 1);

  it('subsequent years tax for petrol vehicles over 50K', () => {
  ...
  it('subsequent years tax for electric vehicles over 50K', () => {
  ...
  it('subsequent years tax for alternative fuel vehicles over 50K', () => {
